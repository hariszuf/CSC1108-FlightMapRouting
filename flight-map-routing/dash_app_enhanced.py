    ...
    <head>
        ...
        <style>
            * { 
            ...
            /* Luxurious Stats Badges */
            .stats-badge {
                background: linear-gradient(135deg, #1e2b4a 0%, #1a243b 100%);
            ...
            /* Tabs Container - Fixed spacing issue */
            .dash-tabs-container {
                margin-top: 30px !important;  /* Added spacing after header */
            ...
            .dash-tab--selected {
                ...
                border-bottom: 3px solid #a5b4fc !important;  /* Thicker border */
                background: linear-gradient(to top, rgba(165, 180, 252, 0.15), transparent) !important;
            ...
            .metric-label {
                color: #a5b4fc;  /* Brighter color for labels */
                font-size: 0.85em;
            ...
            .dash-table table {
                background: rgba(30, 43, 74, 0.8) !important;
            ...
            .dash-table tr:hover td {
                background: rgba(45, 59, 94, 0.8) !important;
                color: #ffffff !important;
            }
            ...
            ::-webkit-scrollbar-thumb {
                background: linear-gradient(135deg, #2d3b5e 0%, #1e2b4a 100%);
                border-radius: 10px;
            }
            
            ::-webkit-scrollbar-thumb:hover {
                background: linear-gradient(135deg, #3d4b6e 0%, #2e3b5a 100%);
            }
            ...
            .js-plotly-plot .plotly .bg {
                fill: rgba(18, 25, 45, 0.9) !important;
            }
            ...
            /* Additional spacing for advanced features */
            .advanced-section {
                margin-top: 20px;
            }
